...
public class SwerveModule {
    ...
    private void setSpeed(SwerveModuleState desiredState, boolean isOpenLoop){
        if(isOpenLoop){
            ...
            if (this.moduleNumber == 3) SmartDashboard.putNumber("Mod 3 Velocity Difference", velocity - getState().speedMetersPerSecond);
    ...
    private void setAngle(SwerveModuleState desiredState){
        ...
        if (this.moduleNumber == 3) SmartDashboard.putNumber("Mod 3 Angle Difference", this.angleOffset.getDegrees() - angle.getDegrees());
